...
import { X, Dumbbell, UtensilsCrossed, Edit, CreditCard, Trash2, Calendar } from 'lucide-react';
            ...
            <div className="flex-shrink-0 bg-brand-navy/90 backdrop-blur-md border-t border-white/10 p-4">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-green-500/20 text-green-400 border border-green-500/30 px-4 py-3 rounded-lg hover:bg-green-500/30 transition-all font-medium"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-blue-500/20 text-blue-400 border border-blue-500/30 px-4 py-3 rounded-lg hover:bg-blue-500/30 transition-all font-medium"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-red-500/20 text-red-400 border border-red-500/30 px-4 py-3 rounded-lg hover:bg-red-500/30 transition-all font-medium"
                >
